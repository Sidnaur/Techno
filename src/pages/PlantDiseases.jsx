    ...
    <div>
      ...
      <div style={{ ...styles.header, padding: isMobile ? '40px 24px 32px' : '60px 60px 50px' }}>
        <div style={styles.headerInner}>
          ...
          <p style={styles.subtitle}>{t("plants_subtitle")}</p>
          <div style={{ ...styles.headerStats, gap: isMobile ? '20px' : '32px' }}>
            {[
      ...
      {/* Page body */}
      <div style={{ ...styles.page, padding: isMobile ? '24px 16px' : '40px 60px' }}>
        ...
        <div style={{
          ...
          <div style={{ ...styles.filterGroup, justifyContent: isMobile ? 'flex-start' : 'flex-start' }}>
            ...
            {categories.map((cat) => (
              <button
                ...
                style={{
                  ...styles.filterBtn,
                  ...(filterCategory === (typeof cat === 'object' ? cat.value : cat) ? styles.filterActive : {}),
                }}
              >
          ...
          <div style={{ ...styles.searchBox, width: isMobile ? '100%' : '260px', boxSizing: 'border-box' }}>
            ...
            return (
              <div key={index} style={{ ...styles.card, borderTop: `3px solid ${colors.label}` }}>
                <div style={styles.cardTop}>
                  ...
                  <button style={styles.expandBtn} onClick={() => setExpanded(isOpen ? null : index)}>
...
const styles = {
  ...
  subtitle: { fontSize: '1rem', color: 'rgba(255,255,255,0.8)', maxWidth: '600px', lineHeight: '1.7', margin: '0 0 32px' },
  headerStats: { display: 'flex' },
  headerStat: { display: 'flex', flexDirection: 'column', gap: '2px' },
  headerStatValue: { fontSize: '1.8rem', fontWeight: '800', color: '#f5a623', lineHeight: 1 },
  headerStatLabel: { fontSize: '0.75rem', color: 'rgba(255,255,255,0.65)', textTransform: 'uppercase', letterSpacing: '0.5px', fontWeight: '600' },
  page: { background: '#f4f9f4', minHeight: '80vh', maxWidth: '100%', boxSizing: 'border-box' },
  controls: {
    display: 'flex', flexWrap: 'wrap',
    marginBottom: '16px', background: 'white',
    border: '1px solid #deeede', borderRadius: '10px', padding: '16px 20px',
  },
  filterLabel: { fontSize: '0.78rem', fontWeight: '700', color: '#666', textTransform: 'uppercase', letterSpacing: '0.5px' },
  filterGroup: { display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center', flex: 1 },
  filterBtn: {
    padding: '7px 14px', borderRadius: '6px', border: '1px solid #d0e8d0',
    background: 'white', cursor: 'pointer', fontSize: '0.85rem', color: '#444', fontWeight: '500',
  },
  ...
  searchInput: { border: 'none', outline: 'none', fontSize: '0.9rem', width: '100%', background: 'transparent', color: '#333' },
  resultCount: { fontSize: '0.85rem', color: '#777', marginBottom: '20px' },
  ...
  cardTop: {
    ...
    padding: '14px 18px', borderBottom: '1px solid #f0f0f0', background: '#fafdfa',
    flexWrap: 'wrap', gap: '10px',
  },
  cardTopLeft: { display: 'flex', alignItems: 'center', gap: '14px' },
  plantImg: { width: '48px', height: '48px', borderRadius: '8px', objectFit: 'cover', border: '1px solid #e0e0e0', flexShrink: 0 },
  categoryTag: {
    display: 'inline-block', fontSize: '0.65rem', fontWeight: '700',
    padding: '2px 8px', borderRadius: '4px', textTransform: 'uppercase',
    letterSpacing: '0.5px', marginBottom: '4px',
  },
  diseaseName: { fontSize: '1.1rem', fontWeight: '700', color: '#1a3d1a', margin: 0 },
  expandBtn: {
    background: '#f4f9f4', border: '1px solid #c8e6c9', color: '#2d6a2d',
    padding: '6px 12px', borderRadius: '6px', fontSize: '0.78rem',
    fontWeight: '600', cursor: 'pointer', flexShrink: 0,
  },
  cardBody: { padding: '12px 18px' },
  description: { fontSize: '0.9rem', color: '#555', lineHeight: '1.5', margin: 0 },
  expandedBody: { padding: '0 18px 14px', borderTop: '1px solid #f0f0f0' },
  infoRow: { display: 'grid', gap: '12px', marginTop: '14px' },
  infoBox: { background: '#f8fdf8', borderRadius: '6px', padding: '12px 14px' },
  infoBoxLabel: { fontSize: '0.7rem', fontWeight: '700', color: '#444', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '6px' },
  infoBoxText: { fontSize: '0.85rem', color: '#444', lineHeight: '1.6', margin: 0 },

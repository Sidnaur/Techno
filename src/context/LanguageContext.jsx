...
const translations = {
  en: {
    ...
    detect_buy_title: "🛒 What to Buy at the Agri-Store",
    detect_store_label: "💬 What to say at the store:",
    detect_tip_remove_damaged_leaves: "Remove the badly damaged leaves to prevent the disease from spreading.",
    detect_tip_water_carefully: "Water the plants carefully to avoid splashing water on the leaves.",
    detect_tip_spray_fungicide: "Spray the plants with a fungicide to kill the disease.",
    detect_buy_dithane: "Dithane M-45 — a fungicide that can be found in most agri-supply stores in the Philippines.",
    detect_buy_agrimycin: "Agrimycin — an antibiotic spray that can help control bacterial infections.",
    detect_store_phrase_fungicide: "I need a fungicide spray to treat leaf spot disease on my plants.",
  ...
  ceb: {
    ...
    plants_d_leaf_spot: "Spot sa Dahon",
    plants_d_early_blight: "Maagang Blight",
    plants_d_late_blight: "Ulahi nga Blight",
    plants_d_powdery_mildew: "Pulbos nga Amag",
    plants_d_downy_mildew: "Humok nga Amag",
    plants_d_bacterial_spot: "Bacterial Spot",
    plants_d_bacterial_leaf_spot: "Bacterial Leaf Spot",
    plants_d_rust: "Rust",
    plants_d_blight: "Blight",
    plants_d_anthracnose: "Anthracnose",
    plants_d_leaf_curl: "Pagkurug sa Dahon",
    plants_d_citrus_canker: "Citrus Canker",
    plants_d_scab: "Scab",
    ...
    detect_buy_title: "🛒 Unsa ang Paliton sa Agri-Store",
    detect_store_label: "💬 Unsa ang isulti sa tindahan:",
    detect_tip_remove_damaged_leaves: "Kuhaa ang daotang mga dahon aron mapugngan ang pagkatap sa sakit.",
    detect_tip_water_carefully: "Tubigi ang mga tanom hinay-hinay aron malikayan ang pag-splash sa tubig sa mga dahon.",
    detect_tip_spray_fungicide: "I-spray ang tanom gamit ang fungicide aron patyon ang sakit.",
    detect_buy_dithane: "Dithane M-45 — usa ka fungicide nga makit-an sa kadaghanan sa mga agri-supply store sa Pilipinas.",
    detect_buy_agrimycin: "Agrimycin — usa ka antibiotic spray nga makatabang sa pagkontrol sa bacterial infections.",
    detect_store_phrase_fungicide: "Kinahanglan nako og fungicide spray aron tambalan ang leaf spot disease sa akong mga tanom.",
  ...
  tl: {
    ...
    plants_d_leaf_spot: "Mantsa sa Dahon",
    plants_d_early_blight: "Maagang Blight",
    plants_d_late_blight: "Huling Blight",
    plants_d_powdery_mildew: "Pulbos na Amag",
    plants_d_downy_mildew: "Malambot na Amag",
    plants_d_bacterial_spot: "Bacterial Spot",
    plants_d_bacterial_leaf_spot: "Bacterial Leaf Spot",
    plants_d_rust: "Rust",
    plants_d_blight: "Blight",
    plants_d_anthracnose: "Anthracnose",
    plants_d_leaf_curl: "Pagkakulobot ng Dahon",
    plants_d_citrus_canker: "Citrus Canker",
    plants_d_scab: "Scab",
    ...
    detect_buy_title: "🛒 Ano ang Bibilhin sa Agri-Store",
    detect_store_label: "💬 Ano ang sasabihin sa tindahan:",
    detect_tip_remove_damaged_leaves: "Alisin ang mga sirang dahon upang maiwasan ang pagkalat ng sakit.",
    detect_tip_water_carefully: "Diligin nang maingat ang mga halaman upang maiwasang sumabog ang tubig sa mga dahon.",
    detect_tip_spray_fungicide: "I-spray ang mga halaman ng fungicide upang puksain ang sakit.",
    detect_buy_dithane: "Dithane M-45 — isang fungicide na makikita sa karamihan ng mga agri-supply store sa Pilipinas.",
    detect_buy_agrimycin: "Agrimycin — isang antibiotic spray na makakatulong kontrolin ang bacterial infections.",
    detect_store_phrase_fungicide: "Kailangan ko ng fungicide spray para gamutin ang leaf spot disease sa aking mga halaman.",
    detect_symptoms: "Mga Sintomas",

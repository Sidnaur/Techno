...
const translations = {
  en: {
    ...
    detect_not_plant_image: "Not a plant image",
    detect_not_plant_leaf: "The uploaded image does not appear to be a plant leaf.",
    detect_upload_clear_leaf: "Please upload a clear photo of a plant leaf.",
  ...
  ceb: {
    ...
    detect_not_plant_image: "Dili usa ka hulagway sa tanom",
    detect_not_plant_leaf: "Ang gi-upload nga larawan dili nagpakita og dahon sa tanom.",
    detect_upload_clear_leaf: "Palihug mag-upload ug klaro nga litrato sa dahon sa tanom.",
  ...
  tl: {
    ...
    detect_not_plant_image: "Hindi larawan ng halaman",
    detect_not_plant_leaf: "Ang na-upload na larawan ay hindi mukhang dahon ng halaman.",
    detect_upload_clear_leaf: "Mangyaring mag-upload ng malinaw na larawan ng dahon ng halaman.",
    detect_symptoms: "Mga Sintomas",
